...
def test_carbon_footprint_instantiation():
    carbon_footprint = CarbonFootprint("kilogram", 1.0, 0.5, 0.3, 0.2, 0.1, "AR6", ["AR6"], ["Standard"], "boundary processes description")
...
def test_carbon_footprint_invalid_declared_unit():
    with pytest.raises(ValueError):
        CarbonFootprint("", 1.0, 0.5, 0.3, 0.2, 0.1, "AR6", ["AR6"], ["Standard"], "boundary processes description")

def test_carbon_footprint_invalid_unitary_product_amount():
    with pytest.raises(ValueError):
        CarbonFootprint("kilogram", 0.0, 0.5, 0.3, 0.2, 0.1, "AR6", ["AR6"], ["Standard"], "boundary processes description")

def test_carbon_footprint_invalid_p_cf_excluding_biogenic():
    with pytest.raises(ValueError):
        CarbonFootprint("kilogram", 1.0, -0.5, 0.3, 0.2, 0.1, "AR6", ["AR6"], ["Standard"], "boundary processes description")
...
def test_carbon_footprint_invalid_characterization_factors():
    with pytest.raises(ValueError):
        CarbonFootprint("kilogram", 1.0, 0.5, 0.3, 0.2, 0.1, "", ["AR6"], ["Standard"], "boundary processes description")
...
def test_carbon_footprint_invalid_cross_sectoral_standards_used():
    with pytest.raises(ValueError):
        CarbonFootprint("kilogram", 1.0, 0.5, 0.3, 0.2, 0.1, "AR6", ["AR6"], [], "boundary processes description")

def test_carbon_footprint_invalid_boundary_processes_description():
    with pytest.raises(ValueError):
        CarbonFootprint("kilogram", 1.0, 0.5, 0.3, 0.2, 0.1, "AR6", ["AR6"], ["Standard"], "")